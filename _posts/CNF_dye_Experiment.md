...
###Methods
Small fragments of corals no larger than 0.5 cm, in this case 4 from _Stylophora pistillata_, were cut from a environmentally controlled laboratory aquarium hosting experimental coral subjects. These fragments were then individually set cut-side down using fast-setting super glue into a well from a 6-well glass plate and covered with artificial sea water (which had previously been filtered through a 0.2 0.2 μm filter. Out of the 4 fragments, 1 was treated with just 100 μl of the CNF polymer, 1 was treated with 100 μl of the CNF polymer and fluorecent dye, and the remaining 2 were left untreated as controls. These were then imaged under a Nikon Eclipse Ti-E inverted fluorescence microscope and analyzed.
...
![CNF 0.5% + dye_wf_CNF 0.5% + dye_wf_RGB](/Users/benberman/Documents/GitHub/BenBerman_Lab_Notebook-Mass_Lab-./images/IMG_5122.png)
